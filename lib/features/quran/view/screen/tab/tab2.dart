...
class Tab2Screen extends StatelessWidget {
  final PdfViewerController controllerPinch;
  const Tab2Screen({
    super.key,
    required this.controllerPinch,
  });
                  ...
                  child: FadeInAnimation(
                    child: InkWell(
                      onTap: () async {
                        ...
                        int indexPage = Data.numberOfJuz[index];
                        ...
                        child: Row(
                          children: [
                            Stack(
                              ...
                              children: [
                                ...
                                Text(
                                  "${index + 1}",
                                  style: TextStyle(
                                      fontSize: 14.sp, fontFamily: "Noor"),
                                ),
                              ],
                            ),
                            SizedBox(
                            ...
                            Text(Data.nameOfJusz[index],
                                style: TextStyle(
                                    fontFamily: "Noor", fontSize: 18.sp)),
                          ],
                        ),
                      ),
                    ),
