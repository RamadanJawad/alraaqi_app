                ...
                ? Padding(
                    ...
                    child: SizedBox(
                      child: GridView.builder(
                          itemCount: controller.morningVideos.length,
                          gridDelegate:
                          ...
                          itemBuilder: (context, index) {
                            final video = controller.morningVideos[index];
                                      ...
                                      child: Image.network(
                                        ...
                                        errorBuilder:
                                          ...
                                          return Image.network(
                                            'https://i.ytimg.com/vi/pPYt9jZjbUE/maxresdefault.jpg', // ضع صورة افتراضية في مجلد الصور
                                            fit: BoxFit.cover,
                                            width: double.infinity,
                                            height: 150.h,
                                          );
                        ...
                        Container(
                          ...
                          child: Transform.scale(
                            ...
                            child: Obx(
                              () => IconButton(
                                onPressed: () {
                                  controller.playSound("sounds/azkar_1.mp3");
                                },
